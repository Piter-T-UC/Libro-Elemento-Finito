...
\begin{tikzpicture}[>=Stealth, scale=1.15]
  ...
  \draw[->, thick] (4.4,-0.3) -- (5.4,-0.3) node[right]{$z$};
  \draw[<->] (0,-0.75) -- (4,-0.75) node[midway, above]{$L^{(e)}$};
...
\begin{tikzpicture}[>=Stealth, scale=1.3]
  ...
  \draw[->, thick, ucblue] (0,0) -- (\dtheta:3.1) node[above right, font=\small]{$z_L$};
  \draw[->, thick, ucblue] (0,0) -- (\dtheta+90:1.4) node[above left, font=\small]{$x_L$};
  \draw[very thick, ucred] (\dtheta:0.5) -- (\dtheta:2.8);
  \filldraw[ucred] (\dtheta:0.5) circle (2pt) node[above=1pt, font=\small]{$1$};
  \filldraw[ucred] (\dtheta:2.8) circle (2pt) node[above=1pt, font=\small]{$2$};
  \draw (0.75,0) arc (0:\dtheta:0.75);
  \node[font=\small] at (\dtheta/2:1.05) {$\theta$};
\end{tikzpicture}
